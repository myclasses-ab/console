              ...
              <tbody className="divide-y divide-slate-100">
                {branches.map((branch) => (
                  <tr key={branch.identifier} className="hover:bg-slate-50">
                    ...
                    <td className="px-5 py-3 text-slate-600 max-w-xs truncate">{branch.addressLine1}</td>
                    ...
                    <td className="px-5 py-3">
                      <span className={`px-2 py-1 rounded-full text-xs font-medium ${branch.isActive ? 'bg-green-50 text-green-700' : 'bg-slate-100 text-slate-600'}`}>
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
          ...
          <div className="relative bg-white rounded-2xl shadow-xl w-full max-w-2xl max-h-[90vh] overflow-y-auto p-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div>
                <label className="block text-sm font-medium text-slate-700 mb-1.5">Total Area (sqft)</label>
                <input
                  type="number"
                  value={editingBranch.totalAreaSqft || ''}
                  onChange={(e) => handleChange('totalAreaSqft', Number(e.target.value))}
                  className="w-full px-4 py-2.5 rounded-xl border border-slate-200 bg-white focus:outline-none focus:ring-2 focus:ring-primary-500"
                />
              </div>
              <div>
                <label className="block text-sm font-medium text-slate-700 mb-1.5">Classrooms</label>
                <input
                  type="number"
                  value={editingBranch.totalClassrooms || ''}
                  onChange={(e) => handleChange('totalClassrooms', Number(e.target.value))}
                  className="w-full px-4 py-2.5 rounded-xl border border-slate-200 bg-white focus:outline-none focus:ring-2 focus:ring-primary-500"
                />
              </div>
              <div>
                ...
                <input
                  type="number"
                  value={editingBranch.seatingCapacity || ''}
